...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            'catering_packages.view' => 'View catering packages.',
            'catering_packages.create' => 'Create catering packages.',
            'catering_packages.update' => 'Update catering packages.',
            'catering_packages.delete' => 'Delete catering packages.',
