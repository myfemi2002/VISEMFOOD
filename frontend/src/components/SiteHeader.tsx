      ...
      <header className="surface-overlay border-soft sticky top-0 z-50 border-b backdrop-blur-xl">
        <div className="page-shell flex items-center justify-between gap-3 py-3 md:py-4">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            {cartCount > 0 ? (
              <Link to="/cart" className="btn-ghost rounded-full px-4">
                View Order
                <span className="inline-flex min-w-6 items-center justify-center rounded-full bg-[var(--vf-primary)] px-2 py-0.5 text-xs font-bold text-white">
                  {cartCount}
                </span>
              </Link>
            ) : null}
          ...
          <div className="flex items-center gap-2 lg:hidden">
            {cartCount > 0 ? (
              <Link to="/cart" className="btn-ghost rounded-full px-4 text-[0.9rem]">
                Order {cartCount}
              </Link>
            ) : null}
        ...
        <div className="lg:hidden">
          ...
          <aside className="drawer-panel floating-surface">
            ...
            <div className="mt-6 grid gap-3">
              ...
              <Link to="/cart" className="surface-overlay-strong border-soft flex items-center justify-between rounded-[var(--vf-radius-md)] border px-4 py-3 text-sm font-semibold text-[var(--vf-text)]">
